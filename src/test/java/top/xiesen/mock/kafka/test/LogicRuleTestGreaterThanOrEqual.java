...
public class LogicRuleTestGreaterThanOrEqual {
    ...
    @Test
    public void whenThanOrEqualIsOne() {
    ...
    @Test
    public void whenThanOrEqualIsTwo() {
        String result = LogicRule.comp1(rules, 21);
        assertEquals("2", result);
        System.out.println(result);
    }

    @Test
    public void whenThanOrEqualIsThree() {
    ...
    public void whenThanOrEqualIsNull() {
        String result = LogicRule.comp1(rules, 1);
